...
def get_ip_data():
    try: 
        ...
        input_size = input("What is the driver size? ")
        input_version = input("What is the driver version? ")
        d = {"IP": input_ip, "driver": input_driver, "size": input_size, "version": input_version}
        return d
    except:
